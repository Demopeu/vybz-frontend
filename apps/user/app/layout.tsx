...
export const metadata: Metadata = {
  ...
  description:
    'VYBZ에서 다양한 버스킹 공연을 실시간으로 즐기고, 좋아하는 버스커를 응원해보세요! 실시간 채팅과 후원으로 버스커와 소통하세요!',
  keywords: [
    'VYBZ',
    '버스커',
    '라이브 스트리밍',
  ...
  authors: [{ name: 'VYBZ', url: 'https://vybz.kr' }],
  openGraph: {
  ...
  twitter: {
    ...
    description:
      'VYBZ에서 다양한 버스킹 공연을 실시간으로 즐기고, 버스커를 응원해보세요!',
    images: ['/busker.vybz.kr_main.png'],
  },
  themeColor: '#000000',
